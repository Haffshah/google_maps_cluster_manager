...
// 20	1 099 511 627 776	0.00025	0.149	1:5 hundred	A mid-sized building
  ...
  double getLatLonDist(LatLng point1, LatLng point2, int zoomLevel) {
    ...
    double dist = getDistanceFromLatLonInKm(point1.latitude, point1.longitude, point2.latitude, point2.longitude) / (meterPerPixel / 1000);
    // print("dist is $x");
  ...
  double getDistanceFromLatLonInKm(double lat1, double lon1, double lat2, double lon2) {
    ...
    var a = sin(dLat / 2) * sin(dLat / 2) + cos(_degreeToRadian(lat1)) * cos(_degreeToRadian(lat2)) * sin(dLon / 2) * sin(dLon / 2);
